...
local infos = {
	...
	{
		key    = 'name',
		value  = 'ChanRTS - Torch-based Machine Learning AI',
		desc   = 'human readable name.',
	},
	{
		key    = 'description',
		value  = 'AI using PyTorch/LibTorch for machine learning decision making.',
		desc   = 'tooltip.',
	},
	{
		key    = 'url',
		value  = 'https://github.com/your-username/chanrts-ai',
